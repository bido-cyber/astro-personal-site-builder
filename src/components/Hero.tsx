    ...
    <section className="min-h-[80vh] lg:min-h-[85vh] flex items-center justify-center pt-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${isRTL ? 'lg:grid-flow-col-dense' : ''}`}>
          ...
          <div className={`flex justify-center order-1 lg:order-2 ${isRTL ? 'lg:col-start-1' : ''}`}>
          ...
          <div className={`space-y-8 order-2 lg:order-1 ${isRTL ? 'lg:col-start-2 text-right' : 'text-left'} text-center lg:text-left`}>
